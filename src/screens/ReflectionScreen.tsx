      ...
      case 0:
        return (
          <div className="step-greeting">
            <h2 className="greeting-title text-reveal">Week Complete — Time to Reflect</h2>
            <p className="greeting-sub">
              ...
              Review what you worked on, then write a short reflection before starting the next week.
            </p>
          </div>
        );
