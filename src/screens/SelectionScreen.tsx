    ...
    switch (index) {
      case 0:
        return (
          <div className="step-greeting">
            <h2 className="greeting-title text-reveal">Pick This Week's Focus</h2>
            <p className="greeting-sub">
              Choose one item from each category. You'll track evidence and reflect at the end of the week.
            </p>
          </div>
        );
        ...
        return (
          <div className="step-section">
            ...
            <p className="step-hint-subtle animate-fade-in" style={{ animationDelay: '0.3s' }}>
              Your values shape which focuses feel worth picking.
            </p>
          </div>
        );
      ...
      case 6:
        return (
          <div className="step-section stack-lg">
            <div className="step-greeting" style={{ padding: '16px 0' }}>
              <h2 className="greeting-title" style={{ fontSize: '2rem' }}>Your Focuses This Week</h2>
              <p className="greeting-sub" style={{ opacity: 1, animation: 'none' }}>Review your selections. Confirm when ready.</p>
            </div>
